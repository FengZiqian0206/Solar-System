import { THREE, context } from './renderer-support.js?v=dense-body-depth-2';
...
void main(){
 ...
 float sizeFactor=.82+aSeed*.36;if(bodyDepth>0.)sizeFactor*=mix(1.,.50+pow(bodyDepth,.58)*2.00,uDenseMode);if(ratio<=.281)sizeFactor*=1.+.16*sin(uTime*(.65+aSeed*.55)+aSeed*6.28318);
